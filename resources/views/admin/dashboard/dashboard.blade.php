      ...
      <div class="row">
        <div class="col-xl-4 cdx-xl-50">
          <div class="card welcome-card overflow-hidden">
            ...
            <div class="card-body">
              <div class="img-wrap"><img class="img-fluid" src="{{('admin')}}/assets/images/avtar/1.jpg" alt="image"></div>
                ...
                <table class="table">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <div class="media">
                          <div class="img-wrap"><img class="img-fluid" src="{{('admin')}}/assets/images/avtar/6.jpg" alt="recent-product"></div>
                    ...
                    <tr>
                      <td>
                        <div class="media">
                          <div class="img-wrap"><img class="img-fluid" src="{{('admin')}}/assets/images/avtar/2.jpg" alt="recent-product"></div>
                    ...
                    <tr>
                      <td>
                        <div class="media">
                          <div class="img-wrap"><img class="img-fluid" src="{{('admin')}}/assets/images/avtar/3.jpg" alt="recent-product"></div>
                    ...
                    <tr>
                      <td>
                        <div class="media">
                          <div class="img-wrap"><img class="img-fluid" src="{{('admin')}}/assets/images/avtar/4.jpg" alt="recent-product"></div>
                    ...
                    <tr>
                      <td>
                        <div class="media">
                          <div class="img-wrap"><img class="img-fluid" src="{{('admin')}}/assets/images/avtar/5.jpg" alt="recent-product"></div>
                ...
                <ul class="chating-list" data-simplebar>
                  <li>
                    <div class="user-msgbox">
                      <div class="media"><img class="img-fluid" src="{{('admin')}}/assets/images/avtar/1.jpg" alt="image">
                        <div class="media-body">
                  ...
                  <li>
                    <div class="admin-msgbox">
                      <div class="media">
                        ...
                        </div><img class="img-fluid" src="{{('admin')}}/assets/images/avtar/2.jpg" alt="image">
                      </div>
                    </div>
                  </li>
                  <li>
